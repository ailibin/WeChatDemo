...
import com.ailibin.softkeyboardinputdemo.MainActivity;
import com.ailibin.softkeyboardinputdemo.R;
import com.ailibin.softkeyboardinputdemo.adpter.NewMsgAdpter;
import com.ailibin.softkeyboardinputdemo.bean.GroupInfo;
import com.ailibin.softkeyboardinputdemo.bean.PublicMsgInfo;
import com.ailibin.softkeyboardinputdemo.bean.User;
import com.ailibin.softkeyboardinputdemo.chat.ChatActivity;
import com.ailibin.softkeyboardinputdemo.common.NetUtil;
import com.ailibin.softkeyboardinputdemo.common.Utils;
import com.ailibin.softkeyboardinputdemo.view.activity.PublishMsgListActivity;
			...
			if (ChatRecord != null) {
				if (conversation.isGroup()) {
					...
					User user = GloableParams.Users.get(conversation
							.getUserName());
					if (user != null) {
						intent.putExtra(Constants.NAME, ((User) user).getUserName());// 设置昵称
						intent.putExtra(Constants.TYPE,
